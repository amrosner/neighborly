...
Once done Neighborly is ready use. To run it locally you can execute the command `php -S localhost:8000`, or your preferred port, in a terminal, inside the folder `/neighborly`.
